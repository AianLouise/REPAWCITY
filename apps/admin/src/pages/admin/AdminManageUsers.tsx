...
import type { User } from '@repaw/api-client'
import { MdArrowDownward, MdArrowUpward, MdDelete, MdGroup, MdSave } from 'react-icons/md'
                ...
                users.map((user) => (
                  <tr key={user.id} className="hover:bg-repaw-bg/40 cursor-pointer" onClick={() => select(user)}>
                    ...
                    <td className="px-3 py-3 space-x-2">
                      ...
                      >
                        {user.user_type === '1' ? <MdArrowDownward size={16} /> : <MdArrowUpward size={16} />}
