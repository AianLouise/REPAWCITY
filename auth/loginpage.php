...
<head>
    ...
    <title>Login — rePaw City</title>
    <meta name="description" content="Log in to rePaw City.">
    ...
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div class="relative hidden lg:block overflow-hidden bg-repaw-dark">
            ...
            <div class="relative h-full flex flex-col justify-between p-10 text-repaw-bg">
                ...
                <div>
                    <h2 class="font-serif text-3xl font-bold leading-tight">Every pet deserves a forever home.</h2>
                    <p class="mt-3 text-repaw-bg/80 max-w-sm">Log in to continue your journey with rePaw City.</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center bg-repaw-bg px-6 py-12">
            <div class="w-full max-w-md">
                ...
                <form class="bg-white/70 rounded-3xl p-8 border border-repaw-hover/40 shadow-sm" name="login" action="../includes/authcode.php" method="post">
                    <div class="text-center mb-8">
                        <h1 class="font-serif text-3xl font-bold text-repaw-dark">WELCOME!</h1>
                    ...
                    <div class="relative mb-4">
                        ...
                        <span class="mui-icon text-repaw-text/60 absolute right-4 top-1/2 -translate-y-1/2 text-[20px] cursor-pointer" id="show-password">visibility</span>
                    </div>
                    ...
                    <p class="text-center text-repaw-text/80 mt-6">Don't have an Account?<br>
                        <a href="signuppage.php" class="text-repaw-dark font-medium underline underline-offset-2 hover:text-repaw-text">Sign Up</a>
                    </p>
                </form>
            </div>
        </div>
