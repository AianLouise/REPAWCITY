...
import type { NewsArticle } from '@repaw/api-client'
import { MdDelete, MdNewspaper, MdPushPin, MdSave } from 'react-icons/md'
    ...
    <div className="space-y-8">
      <div className="bg-white/70 rounded-3xl p-8 border border-repaw-hover/40 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          <MdNewspaper size={30} className="text-repaw-dark" />
