...
import { useAdminSchedules, useScheduleActions } from '../../hooks/useSchedule'
    ...
    <div className="space-y-8">
      <div className="bg-white/70 rounded-3xl p-8 border border-repaw-hover/40 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          <span className="mui-icon text-3xl text-repaw-dark">calendar_month</span>
        ...
        <div className="flex items-center justify-between mb-4">
          <button onClick={() => setMonthOffset((o) => o - 1)} className="mui-icon text-repaw-dark hover:text-repaw-text" aria-label="Previous month">
            chevron_left
          </button>
