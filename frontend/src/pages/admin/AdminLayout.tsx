  ...
  return (
    <div className="min-h-screen bg-repaw-bg text-repaw-text font-sans antialiased">
      <header className="sticky top-0 z-50 flex items-center gap-3 bg-repaw-bg border-b border-repaw-hover/50 px-4 sm:px-6 h-16 shadow-sm">
        ...
        >
          <span className="mui-icon text-[24px]">{sidebarOpen ? 'menu_open' : 'menu'}</span>
        </button>
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          >
            <span className="mui-icon text-[20px]">open_in_new</span> View site
          </a>
          ...
          >
            <span className="mui-icon text-[20px]">logout</span>
      ...
      <div className="flex min-h-[calc(100vh-4rem)]">
        ...
        >
          <div className="flex items-center justify-between mb-4 md:hidden">
            ...
            >
              <span className="mui-icon text-[22px]">close</span>
            </button>
          </div>
