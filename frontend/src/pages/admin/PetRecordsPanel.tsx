...
import { useAdminPetRecords, usePetRecordActions } from '../../hooks/usePetRecords'
import type { PetRecordType } from '../../types'
        ...
        <div className="space-y-3">
          {records.map((r) => (
            <div key={r.id} className="flex items-start gap-3 bg-repaw-bg/50 rounded-2xl p-4">
              <span className="mui-icon text-xl text-repaw-dark mt-0.5">{TYPE_ICON[r.type] ?? 'note'}</span>
